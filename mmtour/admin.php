...
<body>
	<div class="main">
	    <ul>
	      <ul class="list">
	        <li class="logo"><a href="mainPage.php"><img src="images/logo/mainlogo.jpeg" alt="Logo" style="width:36px;height:36px;border-radius:50%"></a></li>
	        <div class="search">

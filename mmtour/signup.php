...
<div class="main">
    <ul>
      <ul class="list">
        <li class="logo"><a href="mainPage.php"><img src="images/logo/mainlogo.jpeg" alt="Logo" style="width:3.6rem;height:3.6rem;border-radius:50%;"></a></li>
        <div class="search">
            <form method="POST" action="info.php">
              <input type="text" name="search_p" placeholder="Search.." size="50">
          
              <input type="image" name="submit_p" src="search_icon.png" alt="Search image" style="width:22;height:22; margin-left: 3.5rem;">
            </form>
        </div>
      </ul>
      <ul class="list2">
        <li><a href="mainPage.php">Home</a></li>
        <li><a id="long" href="destination.pho">Destination</a></li>
        <li><a href="gallery.php">Testimonials</a></li>
        <li><a href="grouptour7'''''''''''''''''''''''''''
